...
import { combine, merge, is_buffer, assign_single_source } from '../src/utils';

describe('merge()', function (t) {
...
describe('combine()', function (t) {
	...
	test('neither is an array', function (st) {
